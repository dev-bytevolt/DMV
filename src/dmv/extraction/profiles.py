...
DOCUMENT_TYPE_FIELD_GUIDANCE: dict[str, tuple[str, ...]] = {
    ...
    "lease_agreement": (
        ...
        "Do not put the lessee into owner_* fields. Do not use driver_* or insured_name.",
    ),
    ...
    "dealer_invoice": (
        "Prefer buyer_name for the purchaser and owner_* only when the form labels an owner.",
        "On lease deals, put the customer/lessee in lessee_name, not owner_*.",
    ...
    "manufacturer_certificate": (
        ...
        "Do not use driver_*, lessee_*, or insured_name.",
    ),
    ...
    "lessor_lender_paperwork": (
        ...
        "Do not use owner_* for the lessee/customer.",
    ),
